...
namespace TaxiServiceControllers.Controllers
{
    ...
    {
        private readonly IRideServiceStateless RidesServices = ServiceProxy.Create<IRideServiceStateless>(new Uri("fabric:/TaxiServiceFabric/RideServiceStateless"));
        private readonly IUserServiceStatefull UsersServices = ServiceProxy.Create<IUserServiceStatefull>(new Uri("fabric:/TaxiServiceFabric/UserServiceStatefull"), new ServicePartitionKey(0), TargetReplicaSelector.PrimaryReplica);
